  ...
  return (
    <main className="mx-auto w-full max-w-6xl space-y-8 px-4 py-10 sm:px-6">
      <header className="space-y-3">
        ...
        <h1 className="text-3xl font-bold text-zinc-900 sm:text-4xl">Guías gastronómicas en Siguatepeque</h1>
        <p className="max-w-3xl text-zinc-600">
          Cada guía es una conversación de mesa: pocos lugares, criterio claro y cero relleno. Si te falta un tema,
          nos escribes y lo vamos sumando.
        </p>
      </header>
        ...
        {guides.map((guide) => (
          ...
          >
            <p className="text-xs font-semibold uppercase tracking-[0.12em] text-emerald-700">
              {guide.featured ? "Guía destacada" : "Guía"}
            </p>
            ...
            <Link
              href={`/guias/${encodeURIComponent(guide.slug)}`}
